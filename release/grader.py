...
grader.addBasicPart('1a-1-basic', test_1a_1, 3,
...
grader.addHiddenPart('1a-2-hidden', test_1a_2, 2,
...
grader.addHiddenPart('1b-1-hidden', get_test_1b(2), 3,
...
grader.addHiddenPart('1b-2-hidden', get_test_1b(3), 2,
                     description="Hidden test for ValueIterationDP. Run ValueIterationDP on BlackjackMDP, then test if V[startState] is correct and ValueIterationDP is faster than ValueIteration.")
...
grader.addBasicPart('2a-1-basic', test_2a_1, 3, maxSeconds=3,
...
def test_2a_2():
    if solution_exist:
        ...
        BlackjackMDP = submission.BlackjackMDP
    mdp = BlackjackMDP(cardValues=[1, 5],
...
grader.addHiddenPart('2a-2-hidden', test_2a_2, 2, maxSeconds=3,
...
grader.addBasicPart('2b-1-basic', test_2b_1, 3, maxSeconds=3,
                    description="Basic test for incorporateFeedback() using NumberLineMDP.")
...
grader.addHiddenPart('2b-2-hidden', test_2b_2, 2, maxSeconds=3,
...
def test_2c_1():
    ...
    rl.incorporateFeedback(
        [(7, None, (0, 1)), 'Quit', 7, (7, None, None)], mdp.isEnd)
...
grader.addBasicPart('2c-1-basic', test_2c_1, 3, maxSeconds=3,
...
def test_2c_2():
    ...
    mdp = BlackjackMDP(cardValues=[1, 3, 5, 8, 10],
                       multiplicity=3, threshold=40, peekCost=1)
...
grader.addHiddenPart('2c-2-hidden', test_2c_2, 2, maxSeconds=20,
